...
<body class="sidebar-mini fixed">
    ...
    <div class="wrapper">
        ...
        <header class="main-header-top hidden-print">
            <a href="/home" class="logo"><img class="img-fluid able-logo" src="assets/images/logo-white.png"
                    alt="logo"></a>
                ...
                <div class="navbar-custom-menu f-right">
                    ...
                    <ul class="top-nav">
                        ...
                        <li class="dropdown">
                            <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"
                                class="dropdown-toggle drop icon-circle drop-image">
                                <span><img class="img-circle" src="assets/images/avatar-69.png" style="width:40px; height: 40px; object-fit: cover;"
                                        alt="User Image"></span>
                                <span>Shubrato <b class="text-muted">(Owner)</b> <i class=" icofont icofont-simple-down"></i></span>
