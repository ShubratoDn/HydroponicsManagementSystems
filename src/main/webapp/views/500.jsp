    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="text-uppercase col-xs-12">
                ...
                <p>oops! Something went wrong. Internal server issue.</p>
                <a href="/home" class="btn btn-error btn-lg waves-effect">back to home page</a>
            </div>
        </div>
        <!-- Row end -->
    </div>
