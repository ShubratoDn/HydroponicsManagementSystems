                        ...
                        <div class="main-friend-list">
                            <div class="media friendlist-box" data-id="1" data-status="online"
                                ...
                                <a class="media-left" href="#!">
                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}/assets//images/avatar-1.png"
                            ...
                            <div class="media friendlist-box" data-id="3" data-status="online" data-username="Alice"
                                ...
                                <a class="media-left" href="#!">
                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}/assets//images/avatar-2.png"
                                        alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media friendlist-box" data-id="7" data-status="offline"
                                ...
                                <a class="media-left" href="#!">
                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}/assets//images/avatar-3.png"
                                        alt="Generic placeholder image">
                            ...
                            <div class="media friendlist-box" data-id="5" data-status="online"
                                ...
                                title="Irina Shayk">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}/assets//images/avatar-4.png"
                                        alt="Generic placeholder image">
                                    <div class="live-status bg-success"></div>
                                </a>
                                <div class="media-body">
                            ...
                            <div class="media friendlist-box" data-id="6" data-status="offline"
                                ...
                                title="Sara Tancredi">
                                <a class="media-left" href="#!">
                                    <img class="media-object img-circle" src="${pageContext.request.contextPath}/assets//images/avatar-5.png"
                                        alt="Generic placeholder image">
                                    <div class="live-status bg-danger"></div>
                                </a>
                                <div class="media-body">
        ...
        <div class="showChat_inner">
            ...
            <div class="media chat-messages">
                <a class="media-left photo-table" href="#!">
                    <img class="media-object img-circle m-t-5" src="${pageContext.request.contextPath}/assets//images/avatar-1.png"
                        alt="Generic placeholder image">
                    <div class="live-status bg-success"></div>
                </a>
            ...
            <div class="media chat-messages">
                ...
                <div class="media-right photo-table">
                    <a href="#!">
                        <img class="media-object img-circle m-t-5" src="${pageContext.request.contextPath}/assets//images/avatar-2.png"
                            alt="Generic placeholder image">
                        <div class="live-status bg-success"></div>
                    </a>
                </div>
