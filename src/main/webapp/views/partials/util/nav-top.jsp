	...
	%>
        ...
        <header class="main-header-top hidden-print">
            <a href="/home" class="logo"><img class="img-fluid able-logo" src="${pageContext.request.contextPath}/assets//images/logo-white.png"
                    alt="logo"></a>
                ...
                <div class="navbar-custom-menu f-right">
                    ...
                    <ul class="top-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"
                                class="dropdown-toggle drop icon-circle drop-image">
                                <span><img class="img-circle" src="${pageContext.request.contextPath}/assets//images/userimages/<%=loggedUser != null ? loggedUser.getImage() : "" %>" style="width:40px; height: 40px; object-fit: cover;"
                                        alt="User Image"></span>
                                <span><%=loggedUser != null ? loggedUser.getFirstName() : "" %> <b class="text-muted">(<%=loggedUser != null ? loggedUser.getRole() : "" %>)</b> <i class=" icofont icofont-simple-down"></i></span>
